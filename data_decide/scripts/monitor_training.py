...
def create_layout():
    ...
    layout.split_column(Layout(name="header", size=3), Layout(name="main", ratio=2), Layout(name="footer", size=3))

    layout["main"].split_row(Layout(name="metrics", ratio=1), Layout(name="progress", ratio=1))
...
def get_progress_panel(run_data):
    ...
    return Panel(str(progress) + info, title="Progress", border_style="green")
