            ...
            with gzip.open(file_path, "rt") as f:
                ...
                for line in f:
                    ...
                    if len(batch_texts) >= self.batch_size:
                        # Tokenize batch
                        batch_tokens = self.tokenizer(batch_texts, truncation=False, add_special_tokens=False)[
                            "input_ids"
                        ]
                ...
                if batch_texts:
                    batch_tokens = self.tokenizer(batch_texts, truncation=False, add_special_tokens=False)["input_ids"]
