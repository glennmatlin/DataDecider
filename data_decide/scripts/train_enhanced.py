            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if (step + 1) % training_config.get('gradient_accumulation_steps', 1) == 0:
                    ...
                    if global_step % training_config.get("proxy_metrics_steps", 50) == 0:
                        ...
                        console.print(f"[green]DataDecide Metrics:[/green] "
                    ...
                    if global_step % training_config["eval_steps"] == 0:
                        ...
                        eval_progress = progress.add_task(
                            "Evaluating", 
                            total=min(50, len(eval_dataloader))
                        )
                        ...
                        console.print(f"[green]Evaluation:[/green] Loss: {eval_loss:.4f}, Perplexity: {eval_perplexity:.2f}")
                        model.train()
